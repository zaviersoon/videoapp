...
function ContentApi() {
    ...
    let makeApiCall = ()=>{
        axios.get("https://jsonplaceholder.typicode.com/todos")
            .then((response)=>{
                ...
                // Instialize the response.data to the state so that
                // values in the response.data are initialized to the state
                // variable.
    ...
    return ( 
        <div>
            <h1>Load the data by making a call to a remote API</h1>
